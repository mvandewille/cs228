...
public class PolarAngleComparator implements Comparator<Point>
{
    ...
    {
    	if ((p1.equals(referencePoint) && p2.equals(referencePoint)) || ((!p2.equals(referencePoint) && !p1.equals(referencePoint)) && (crossProduct(p1, p2) > 0)))
    	{
    		return 0;
    	}
    	else
    	{
    		...
    		{
    			if (p1.getY() == p2.getY() && p2.getY() == referencePoint.getY() && p1.getX() > referencePoint.getX() && p2.getX() < referencePoint.getX())
    			{
    				return -1;
    			}
    			...
    			if (p1.getY() > referencePoint.getX() && p2.getY() > referencePoint.getY() && crossProduct(p1, p2) > 0)
    			{
    				return -1;
    			}
